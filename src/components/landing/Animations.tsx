...
export function ScaleUp({ children, delay = 0, className = '' }: AnimProps) {
  const ref = useRef(null)
  const inView = useInView(ref, { once: true, margin: '-80px' })
  return (
    <motion.div
...
// Hero text animations (faster, no scroll trigger needed)
export function HeroFadeUp({ children, delay = 0, className = '' }: AnimProps) {
  return (
    <motion.div
