  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        />
        {/* Gradient overlay: solid left fading to transparent right */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
            {peritosEspecializados.map((perito) => (
              <div
                key={perito.nombre}
                className="group flex flex-col items-center gap-4 p-6 sm:p-8 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/15 hover:border-gold/40 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-gold/10"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {beneficios.map((beneficio, i) => (
              <div key={i} className="flex gap-5 p-6 rounded-xl bg-white/5 border border-white/10 hover:border-gold/30 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {faqs.map((faq) => (
              <div
                key={faq}
                className="bg-navy/60 border border-white/10 rounded-xl p-5 backdrop-blur-sm"
              >
      ...
      <section className="bg-navy py-16 sm:py-20">
        {/* Gold separator */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-1 bg-gold rounded mb-12" />
      ...
      <footer className="bg-navy-dark py-12">
        {/* Gold separator */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-1 bg-gold rounded mb-10" />
